...
"""Test objects for interacting with a yatripayd node over the p2p protocol.

The P2PInterface objects interact with the yatripayd nodes under test using the
