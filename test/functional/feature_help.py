...
"""Verify that starting yatripay with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start yatripay with -h for help text")
        ...
        self.log.info("Start yatripay with -version for version information")
        ...
        self.log.info("Start yatripayd with -fakearg to make sure it does not start")
