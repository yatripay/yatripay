...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 YTP from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 YTP in block rewards plus fees, but
        ...
        # Send 10 YTP with subtract fee from amount
        ...
        # Sendmany 10 YTP with subtract fee from amount
        ...
        if not self.options.descriptors:
            ...
            # This will raise an exception for attempting to get the private key of an invalid Yatripay address
            assert_raises_rpc_error(-5, "Invalid Yatripay address", self.nodes[0].dumpprivkey, "invalid")

            # This will raise an exception for attempting to set a label for an invalid Yatripay address
            assert_raises_rpc_error(-5, "Invalid Yatripay address", self.nodes[0].setlabel, "invalid address", "label")

            # This will raise an exception for importing an invalid address
            assert_raises_rpc_error(-5, "Invalid Yatripay address or script", self.nodes[0].importaddress, "invalid")
