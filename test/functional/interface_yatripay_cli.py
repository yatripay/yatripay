...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `yatripay-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and yatripay-cli getwalletinfo return expected wallet info")
            ...
            # Test yatripay-cli -generate with -rpcwallet in multiwallet mode.
