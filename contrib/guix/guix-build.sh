...
for host in ${HOSTS=x86_64-linux-gnu arm-linux-gnueabihf aarch64-linux-gnu riscv64-linux-gnu x86_64-w64-mingw32}; do
    ...
    (
        ...
        #     same exact path (e.g. mapping '/home/satoshi/yatripay/' to
        #     '/home/satoshi/yatripay/'). This means that the $PWD inside the
        ...
        #   --share="$PWD"=/yatripay
        #
        #                     maps our current working directory to /yatripay
        ...
        #     container so that we have something to build. '/yatripay' was
        #     chosen arbitrarily.
        #
        ...
        time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                                 ...
                                 -- env HOST="$host" \
                                      ...
                                      bash -c "cd /yatripay && bash contrib/guix/libexec/build.sh"
    )
