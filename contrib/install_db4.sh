...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the yatripay repository."
  exit 1
fi
...
# See https://github.com/yatripay/yatripay/issues/16064
...
echo 'When compiling yatripayd, run `./configure` in the following way:'
echo
