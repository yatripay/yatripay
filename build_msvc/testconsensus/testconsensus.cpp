...
// yatripay includes.
#include <..\src\script\yatripayconsensus.h>
...
int main()
{
    std::cout << "yatripayconsensus version: " << yatripayconsensus_version() << std::endl;
    ...
    auto op0Result = yatripayconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, yatripayconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
