 ...
 * for both yatripayd and yatripay-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("Yatripay");
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/yatripay/bips/blob/master/bip-0014.mediawiki)
 */
