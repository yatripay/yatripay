...
/* A AEAD class for ChaCha20-Poly1305@yatripay.
 *
 ...
 *
 * The chacha20-poly1305@yatripay combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@yatripay cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@yatripay are relatively fast in
