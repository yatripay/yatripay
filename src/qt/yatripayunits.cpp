...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(YTP);
    unitlist.append(mYTP);
    unitlist.append(uYTP);
    unitlist.append(SAT);
    return unitlist;
}
...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case YTP: return QString("YTP");
    case mYTP: return QString("mYTP");
    case uYTP: return QString::fromUtf8("µYTP (bits)");
...
QString BitcoinUnits::shortName(int unit)
{
    switch(unit)
    {
    case uYTP: return QString::fromUtf8("bits");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case YTP: return QString("Bitcoins");
    case mYTP: return QString("Milli-Bitcoins (1 / 1" THIN_SP_UTF8 "000)");
    case uYTP: return QString("Micro-Bitcoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case YTP: return 100000000;
    case mYTP: return 100000;
    case uYTP: return 100;
    case SAT: return 1;
