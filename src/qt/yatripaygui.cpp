...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Yatripay address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and yatripay: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Yatripay addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Yatripay addresses"));
    ...
    openAction->setStatusTip(tr("Open a yatripay: URI"));
