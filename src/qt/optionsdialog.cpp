    ...
    mapper(nullptr)
{
    ...
    ui->yatripayAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->yatripayAtStartup);
    ...
    ui->yatripayAtStartup->setToolTip(ui->yatripayAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->yatripayAtStartup->setText(ui->yatripayAtStartup->text().arg(PACKAGE_NAME));
...
{
    /* Main */
    mapper->addMapping(ui->yatripayAtStartup, OptionsModel::StartAtStartup);
