...
public:
     ...
     * on this yatripay node, and set to 0 for transactions that were created
...
private:
    ...
    void StakeYTPs(bool fStake, CConnman* connman, ChainstateManager* chainman, CTxMemPool* mempool);
