...
router", implementing the yatripay wire protocol and relay, making
...
during the *configure* step of building yatripayd:
...
For instance:
    ...
    $ yatripayd -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubhashtx=tcp://192.168.1.2:28332 \
               -zmqpubrawtx=ipc:///tmp/yatripayd.tx.raw \
...
These options can also be provided in yatripay.conf.
...
From the perspective of yatripayd, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into yatripayd directly. Furthermore, no information is
