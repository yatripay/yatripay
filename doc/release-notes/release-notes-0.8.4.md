Bitcoin-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/yatripay/files/Bitcoin/yatripay-0.8.4/
...
code, causing the Bitcoin-Qt or yatripayd process to crash.
Bloom filters were introduced with version 0.8, so versions 0.8.0
through 0.8.3 are vulnerable to this critical denial-of-service attack.

A constant-time algorithm is now used to check RPC password
guess attempts; fixes https://github.com/yatripay/yatripay/issues/2838
(CVE-2013-4165)
...
Linux: clicking on yatripay: links was broken if you were using
