Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://yatripay.org/bin/yatripay-core-0.13.2/>
...
- #8908 `4a974b2` Update yatripay-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow yatripay-tx to create v2 transactions (BTCdrak)
