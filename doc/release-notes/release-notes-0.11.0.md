Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://yatripay.org/bin/yatripay-core-0.11.0/>
...
For example, add the following to `yatripay.conf`:
...
related to the blockchain in the yatripay system: the raw blocks as received over 
...
For an example script see [yatripay-submittx](https://github.com/laanwj/yatripay-submittx).
...
- #5334 `cf87536` libyatripayconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new yatripay-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add yatripay logo to about screen
...
- #5809 `46bfbe7` Add yatripay-cli man page
...
- #5849 `41259ca` contrib/init/yatripayd.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for yatripay-tx)
