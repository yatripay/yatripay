Bitcoin Core version 0.10.4 is now available from:
  ...
  <https://yatripay.org/bin/yatripay-core-0.10.4/>
...
- #6953 `43c2789` Split yatripay-tx into its own package
- #6953 `dfe0d4d` Include yatripay-tx binary on Debian/Ubuntu
