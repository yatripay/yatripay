Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/yatripay/files/Bitcoin/yatripay-0.7.0/

We recommend that everybody running prior versions of yatripayd/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/yatripay/yatripay/tarball/v0.7.0  # .tar.gz
  https://github.com/yatripay/yatripay/zipball/v0.7.0  # .zip
...
in your terminal, then install the yatripay-qt package:
  sudo apt-get install yatripay-qt
...
Core yatripay handling and blockchain database
...
* Ensure a changed yatripay unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for yatripay-qt.exe
* (Windows only): add meta-data to yatripay-qt.exe (e.g. description)
...
* Bash programmable completion for yatripayd(1)
